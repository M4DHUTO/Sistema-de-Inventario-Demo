...
CREATE TABLE IF NOT EXISTS products (
  ...
  category_name VARCHAR(100) NOT NULL REFERENCES categories(name) ON UPDATE CASCADE ON DELETE RESTRICT,
...
-- 3. Tabla de Trazabilidad y Logs de Auditoría
...
-- 5. Trigger para actualización automática de 'updated_at' en productos
